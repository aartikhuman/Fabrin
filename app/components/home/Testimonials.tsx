                            ...
                            <SwiperSlide key={item.id} className="h-auto">
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-4 mt-auto">
                                        <div className="w-14 h-14 rounded-full overflow-hidden border-2 border-brown/20">
                                            <img
                                                src={item.image}
                                                alt={item.name}
                                        ...
                                        <div>
                                            <h4 className="text-xl font-bold font-big uppercase tracking-wider text-black-100">
                                                {item.name}
                                            </h4>
